...
extern "C" {
void* spike_cosim_init(svBitVecVal* start_pc, svBitVecVal* start_mtvec, const char* log_file_path_cstr) {
  ...
  SpikeCosim* cosim = new SpikeCosim(start_pc[0], start_mtvec[0], log_file_path,
                                     false, true);
